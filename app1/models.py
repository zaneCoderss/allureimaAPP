...
class Todo(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE) # getting unique id for each user (allureima studnets/artits in this case) so we cna maintain context.
